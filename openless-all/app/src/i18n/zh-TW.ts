...
export const zhTW: typeof zhCN = {
  ...
  ghostwriter: {
    ...
    snippets: {
      title: '常用語',
      kicker: '指令台',
      desc: '存下你調優過的說法：說話中說到觸發詞，對應表述就按貼位融進貼給 AI 的文本。',
      listTitle: '全部常用語',
      listCount: '{{count}} 條',
      loading: '載入中…',
      ...
      kindBackgroundHint: '整條作為背景，按落點附在開頭或文末。',
      disabledBadge: '已停用',
      unsavedBadge: '未儲存',
      trigger: '觸發詞',
      ...
      textBackgroundPlaceholder: '命中後整條附到開頭或文末',
      ...
      tagPhrasingWithBackground: '融進正文＋背景',
