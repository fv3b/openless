...
export const en: typeof zhCN & {
  ...
  ghostwriter: {
    ...
    snippets: {
      ...
      desc: 'Save your best-tuned phrasings: when a trigger word comes up mid-speech, the matching text is merged into the instruction text at its placement.',
      ...
      kindBackgroundHint: 'The whole entry attaches as a background block at the head or tail.',
      ...
      textBackgroundPlaceholder: 'Attached at the head or tail on hit',
      ...
      placementHead: 'At the head',
      placementTail: 'At the tail',
      tagPhrasingInline: 'Merged inline',
      tagPhrasingWithBackground: 'Inline + background',
