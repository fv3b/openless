...
export const ko: typeof zhCN = {
  ...
  ghostwriter: {
    ...
    snippets: {
      title: '짧은 구문',
      kicker: '지시 콘솔',
      desc: '다듬어 둔 표현을 저장하세요. 말하는 중 트리거 단어가 나오면 해당 표현이 배치 위치에 따라 AI에 전달할 텍스트에 반영됩니다.',
      listTitle: '모든 짧은 구문',
      listCount: '{{count}}개',
      loading: '불러오는 중…',
      ...
      kindBackgroundHint: '한 줄 전체가 배경 블록으로 앞 또는 끝에 붙습니다.',
      disabledBadge: '비활성',
      unsavedBadge: '저장 안 됨',
      trigger: '트리거 단어',
      ...
      textBackgroundPlaceholder: '히트하면 앞 또는 끝에 붙습니다',
      ...
      placementLabel: '위치',
      placementHead: '앞에 붙이기',
      placementTail: '끝에 붙이기',
      tagPhrasingInline: '본문에 반영',
      tagPhrasingWithBackground: '본문＋배경',
