...
export const en: typeof zhCN & {
  ...
  ghostwriter: {
    ...
    panel: {
      ...
      stageFinalizing: 'Composing…',
      stageInserting: 'Inserting…',
      failTitle: 'Insert failed',
      failHint: 'Text was not inserted',
      failTimeout: 'Timed out',
      dismiss: 'Close',
    },
    snippets: {
      title: 'Snippets',
      kicker: 'Instruction console',
      desc: 'Save your best-tuned phrasings: when a trigger word comes up mid-speech, the matching text is merged into the instruction text.',
      listTitle: 'All snippets',
      listCount: '{{count}} items',
      loading: 'Loading…',
      emptyTitle: 'Save your tuned phrasings, ready on every trigger',
      searchPlaceholder: 'Search triggers, aliases or text…',
      filterAll: 'All',
      filterPhrasing: 'Phrasing',
      filterBackground: 'Background',
      emptyFiltered: 'No matching snippets',
      clearFilters: 'Clear search and filters',
      kindLabel: 'Kind',
      kindPhrasing: 'Phrasing',
      kindBackground: 'Background',
      kindPhrasingHint: 'On hit, the text merges into the main text; can carry background material.',
      kindBackgroundHint: 'Attaches as a background block; head or tail is decided by the global “Background placement” setting.',
      unsavedBadge: 'Unsaved',
      trigger: 'Trigger word',
      triggerPlaceholder: 'Fires when spoken, e.g. Translate',
      triggerHint: 'Required; trigger words must be unique.',
      aliases: 'Aliases',
      aliasesPlaceholder: 'Separate multiple aliases with commas',
      aliasesHint: 'Aliases hit exactly like trigger words.',
      textPhrasing: 'Phrase text',
      textBackground: 'Background text',
      textPhrasingPlaceholder: 'Merged into the instruction text on hit',
      textBackgroundPlaceholder: 'Attaches as a background block at the head or tail on hit',
      attachmentsTitle: 'Background attachments',
      attachmentsHint: 'When this phrasing hits, attachments join the background block together with the text.',
      attachmentAddReference: 'Pick existing',
      attachmentAddText: 'Write one',
      attachmentMissingReference: 'Missing',
      attachmentNoOptions: 'No background snippets available yet.',
      tagPhrasingInline: 'Merged inline',
      tagBackgroundHead: 'At the head',
      tagBackgroundTail: 'At the tail',
      enabled: 'Enabled',
      ...
      extractWindowNote: 'Voice records with transcripts (full history)',
      extractedMark: 'Extracted',
      extractEmpty: 'No extractable voice records',
    ...
    conversation: {
      ...
      enableDesc: 'Off by default. Press the conversation hotkey to start a session with the AI, get asked follow-ups while you speak, and have the whole chat polished into an instruction at the end. Requires the ghostwriter style (Ghostwriter floating panel).',
      hotkey: 'Conversation hotkey',
      hotkeyDesc: 'Press with no session＝start a conversation; press during a session in explicit handoff mode＝hand the floor to the AI.',
      hotkeyUnsetHint: 'No conversation hotkey recorded yet; you need one to start a conversation.',
      hotkeyModifierOnly: 'A lone modifier cannot be registered as a global hotkey — add a primary key',
      timing: 'Reply timing',
      timingDesc: 'On pause: the AI reviews as soon as you pause; Explicit handoff: the AI only speaks when you press the hotkey (bypasses cooldown).',
      timingPause: 'On pause',
      timingExplicit: 'Explicit handoff',
      depth: 'Follow-up depth',
      depthDesc: 'One at a time: the AI waits for you after each reply; Until clear: keeps asking until things are clear (capped); Echo: the AI restates your intent for confirmation.',
      depthSingle: 'One at a time',
      depthUntilClear: 'Until clear',
      depthEcho: 'Echo',
      recommendations: 'Show recommendations in conversation',
      recommendationsDesc: 'Keep a persistent list of recommended triggers at the top of the panel during a conversation, refreshing with content.',
    },
  },
  nav: {
    overview: 'Overview',
  ...
  history: {
    ...
    ghostwriterChat: 'Chat transcript',
    ghostwriterChatRoleUser: 'Me',
  ...
  vocab: {
    ...
    extract: {
      entry: 'Extract hotwords from voice records',
      pickTitle: 'Extract hotwords',
      pickHint: 'Pick voice records (full history with transcripts)',
      pickEmpty: 'No extractable voice records',
      selectedCount: '{{count}} selected',
      start: 'Start extraction',
      extracting: 'Extracting…',
      extractFailed: 'Extraction failed: {{error}}',
      extractEmptyResult: 'No likely misrecognized words found',
      reviewTitle: 'Edit hotword candidates',
      reviewHint: 'Suggested hotwords are editable; check the ones to add',
      hotwordPlaceholder: 'Suggested hotword',
      saveFailedDuplicate: 'A dictionary entry already exists or adding failed; tweak the wording and retry',
      save: 'Add to dictionary',
      savedSummary: 'Added {{count}} hotwords',
      partialSummary: 'Added {{count}}, {{failed}} not added',
  ...
  settings: {
    ...
    ghostwriter: {
      ...
      backgroundPlacement: 'Background placement',
      backgroundPlacementDesc: 'Background snippets and phrasing attachments attach at the head or tail uniformly; changes apply immediately.',
      backgroundPlacementHead: 'At the head',
      backgroundPlacementTail: 'At the tail',
    },
    kicker: 'SETTINGS',
    title: 'Settings',
    ...
    recording: {
      ...
      capsuleStyleFluid: 'Ghostwriter floating panel',      muteDuringRecordingLabel: 'Mute while recording',
