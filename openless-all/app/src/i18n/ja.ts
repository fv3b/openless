...
export const ja: typeof zhCN = {
  ...
  ghostwriter: {
    ...
    panel: {
      ...
      recording: '音声入力中',
      preparing: '準備中',
      previewPlaceholder: '話し始めると指示プレビューが表示されます',
      cancelLast: '直前の操作を取り消す',
      noticePastedConfirm: '貼り付けを送信しました。貼り付け先を確認してください',
      noticeCopiedFallback: 'コピーしました。手動で貼り付けてください',
      noticeNotRequested: '処理完了',
      noticeInserted: '{{count}} 文字を入力しました',
      kindTerm: '呼び名',
      kindNaming: '命名',
      recommendLabel: '定型句',
      candidateLabel: '候補',
      ...
      replyPrefix: 'アシスタント',
      stageTranscribing: '文字起こし中…',
      stagePolishing: '推敲中…',
      stageFinalizing: '稿を起こし中…',
      stageInserting: '挿入中…',
      failTitle: '挿入に失敗しました',
      failHint: 'テキストは挿入されていません',
      failTimeout: '処理がタイムアウトしました',
      dismiss: '閉じる',
    },
    snippets: {
      title: '定型句',
      kicker: '指示コンソール',
      desc: '調整済みの言い回しを保存：発話中にトリガーワードが出ると、対応する文章が AI へ渡すテキストに織り込まれます。',
      listTitle: 'すべての定型句',
      listCount: '{{count}} 件',
      loading: '読み込み中…',
      emptyTitle: '調整済みの言い回しを保存して、トリガーワードですぐ呼び出す',
      searchPlaceholder: 'トリガーワード・別名・本文を検索…',
      filterAll: 'すべて',
      filterPhrasing: '本文',
      filterBackground: '背景',
      emptyFiltered: '一致する定型句がありません',
      clearFilters: '検索と絞り込みをクリア',
      kindLabel: '種類',
      kindPhrasing: '本文',
      kindBackground: '背景',
      kindPhrasingHint: 'ヒットすると本文に織り込まれます。背景素材を添付できます。',
      kindBackgroundHint: '1 件まるごと背景ブロックとして付きます。先頭か末尾かは設定の「背景の位置」で決まります。',
      unsavedBadge: '未保存',
      trigger: 'トリガーワード',
      triggerPlaceholder: '発話中に反応します。例：翻訳',
      triggerHint: '必須。同じトリガーワードは重複できません。',
      aliases: '別名',
      aliasesPlaceholder: '複数の別名はカンマで区切る',
      aliasesHint: '別名もトリガーワードと同様にヒットします。',
      textPhrasing: '本文テキスト',
      textBackground: '背景テキスト',
      textPhrasingPlaceholder: 'ヒットすると AI へ渡すテキストに織り込まれます',
      textBackgroundPlaceholder: 'ヒットすると背景ブロックとして先頭または末尾に付きます',
      attachmentsTitle: '添付する背景',
      attachmentsHint: 'この定型句がヒットすると、添付内容もテキストと一緒に背景ブロックへ入ります。',
      attachmentAddReference: '既存から選ぶ',
      attachmentAddText: '手書きで追加',
      attachmentMissingReference: '無効',
      attachmentNoOptions: '選択できる背景の定型句がまだありません。',
      tagPhrasingInline: '本文に織り込む',
      tagBackgroundHead: '先頭に付ける',
      tagBackgroundTail: '末尾に付ける',
      enabled: '有効',
      editTitle: '定型句を編集',
      createTitle: '定型句を新規作成',
      delete: '削除',
      deleting: '削除中…',
      close: '閉じる',
      refresh: '更新',
      ...
      extract: '音声記録から抽出',
      extractTitle: '音声記録から定型句を抽出',
      extractPickTitle: '音声記録を選択',
      extractReviewTitle: '候補を編集',
      extractWindowNote: '転写ありの音声記録（全履歴）',
      extractedMark: '抽出済み',
      extractEmpty: '抽出できる音声記録がありません',
      extractStart: '抽出を開始',
      extractSave: '選択したものを保存',
      extractSelectedCount: '{{count}} 件を選択中',
      extractSavedSummary: '{{count}} 件を保存しました',
      extractPartialSummary: '{{count}} 件を保存。{{failed}} 件はトリガー重複で未保存',
      extractExtracting: '抽出中…',
    ...
    accuracy: {
      title: '認識精度アップ',
      secondPass: "二段階レビュー",
      secondPassDesc: "認識エンジンが区切りごとに非ストリーミングモデルで再確認します。同じ言い回しで誤認識が減り、結果はやや遅くなります。既定はオンで、Volcengine エンジンのみ有効です。",
      inputBox: "入力ボックス活用",
      inputBoxDesc: "会話開始時にカーソルのある入力欄の既存テキストを読み取り、認識の文脈として渡します。続きを現在の文書に自然につながるようにします。会話セッションのみ、Volcengine エンジンのみ有効。テキストは認識リクエストとともに Volcengine のサーバーへ送信されます。既定はオン。",
    ...
    conversation: {
      title: '会話',
      enable: '会話モード',
      enableDesc: 'デフォルトはオフ。会話ホットキーで AI とのセッションを始め、質問を受けながら話を整理し、終了するとチャット全体が指示に整えられます。代筆スタイル（Ghostwriter フローティングパネル）でのみ使用できます。',
      hotkey: '会話ホットキー',
      hotkeyDesc: 'セッション未開始時に押す＝会話を開始。明示的受け渡しモードでセッション中に押す＝話題を AI に渡す。',
      hotkeyUnsetHint: '会話ホットキーが未設定です。設定しないと会話を始められません。',
      hotkeyModifierOnly: '修飾キーのみではグローバルホットキーに登録できません。主キーを追加してください',
      timing: '返答タイミング',
      timingDesc: '一時停止で即審査：話が止まると AI がすぐ確認。明示的受け渡し：話し終えてホットキーを押した時だけ渡す（クールダウン無視）。',
      timingPause: '一時停止で即審査',
      timingExplicit: '明示的受け渡し',
      depth: '質問の深さ',
      depthDesc: '一問一答：AI は 1 回返したらあなたの返答を待つ。聞き直し：明確になるまで質問（回数上限あり）。復唱確認：AI が意図を復唱して確認を求める。',
      depthSingle: '一問一答',
      depthUntilClear: '聞き直し',
      depthEcho: '復唱確認',
      recommendations: '会話中におすすめを表示',
      recommendationsDesc: '会話セッションのパネル上部におすすめフレーズを常駐表示し、内容に応じて更新されます。',
    },
  },
  nav: {
    overview: '概要',
  ...
  history: {
    ...
    ghostwriterHits: '今回のヒット',
    ghostwriterSelections: '選択した候補',
    ghostwriterChat: 'チャット履歴',
    ghostwriterChatRoleUser: '私',
    ghostwriterChatRoleAssistant: 'アシスタント',
    inserted: '入力済み',
    pasteSent: '貼り付けを試行',
  ...
  vocab: {
    ...
    extract: {
      entry: '音声記録から熱語を抽出',
      pickTitle: '熱語を抽出',
      pickHint: '音声記録を選択（転写ありの全履歴）',
      pickEmpty: '抽出できる音声記録がありません',
      selectedCount: '{{count}} 件選択中',
      start: '抽出を開始',
      extracting: '抽出中…',
      extractFailed: '抽出に失敗しました: {{error}}',
      extractEmptyResult: '認識が乱れていそうな語は見つかりませんでした',
      reviewTitle: '熱語候補を編集',
      reviewHint: '提案熱語は編集できます。チェックした語を辞書に追加',
      hotwordPlaceholder: '提案熱語',
      saveFailedDuplicate: '辞書に同じ語があるか追加に失敗。表現を変えて再試行してください',
      save: '辞書に追加',
      savedSummary: '{{count}} 件の熱語を追加しました',
      partialSummary: '{{count}} 件追加、{{failed}} 件は未追加',
      back: '選択に戻る',
      extractedMark: '抽出済み',
      hoursAgo: '{{n}} 時間前',
      yesterday: '昨日',
  ...
  settings: {
    ...
    ghostwriter: {
      ...
      backgroundPlacement: '背景の位置',
      backgroundPlacementDesc:
        '背景の定型句と添付背景は先頭か末尾にまとめて付きます。変更はすぐに反映されます。',
      backgroundPlacementHead: '先頭に付ける',
      backgroundPlacementTail: '末尾に付ける',
    },
    selectionPolish: {
      title: '選択範囲の推敲',
      hotkey: '起動ショートカット',
    ...
    recording: {
      ...
      capsuleStyleFluid: 'Ghostwriter フローティングパネル',      muteDuringRecordingLabel: '録音中はミュート',
