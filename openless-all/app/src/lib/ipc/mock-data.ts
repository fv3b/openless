...
export let mockSettings: UserPreferences = {
  ...
  ghostwriter: {
    ...
    conversationHotkey: null,
    conversationReplyTiming: 'pause',
    conversationProbeDepth: 'single',
    conversationRecommendations: true,
    recentVoiceBackgroundEnabled: false,
    recentVoiceBackgroundAmount: 3,
    recentVoiceBackgroundUnit: 'sessions',
  },
  ...
  retainRecordingsInHistory: true,
