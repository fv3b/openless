...
export const ja: typeof zhCN = {
  ...
  ghostwriter: {
    ...
    snippets: {
      title: '定型句',
      kicker: '指示コンソール',
      desc: '調整済みの言い回しを保存：発話中にトリガーワードが出ると、対応する文章が指定位置に沿って AI へ渡すテキストに織り込まれます。',
      listTitle: 'すべての定型句',
      listCount: '{{count}} 件',
      loading: '読み込み中…',
      ...
      kindBackgroundHint: '1 件まるごと背景ブロックとして先頭または末尾に付きます。',
      disabledBadge: '無効',
      unsavedBadge: '未保存',
      trigger: 'トリガーワード',
      ...
      textBackgroundPlaceholder: 'ヒットすると先頭または末尾に付きます',
      ...
      placementLabel: '位置',
      placementHead: '先頭に付ける',
      placementTail: '末尾に付ける',
      tagPhrasingInline: '本文に織り込む',
      tagPhrasingWithBackground: '本文＋背景',
