...
export const ko: typeof zhCN = {
  ...
  ghostwriter: {
    ...
    panel: {
      ...
      recording: '음성 입력 중',
      preparing: '준비 중',
      previewPlaceholder: '말하기 시작하면 지시 미리보기가 표시됩니다',
      cancelLast: '마지막 작업 취소',
      noticePastedConfirm: '붙여넣기를 보냈습니다. 붙여넣을 위치를 확인하세요',
      noticeCopiedFallback: '복사했습니다. 직접 붙여넣으세요',
      noticeNotRequested: '처리 완료',
      noticeInserted: '{{count}}자 입력했습니다',
      kindTerm: '명칭',
      kindNaming: '이름',
      ...
      replyPrefix: '어시스턴트',
      stageTranscribing: '받아쓰기 중…',
      stagePolishing: '다듬는 중…',
      stageFinalizing: '초안 작성 중…',
      stageInserting: '삽입 중…',
      failTitle: '삽입 실패',
      failHint: '텍스트가 입력되지 않았어요',
      failTimeout: '처리 시간 초과',
      dismiss: '닫기',
    },
    snippets: {
      title: '짧은 구문',
      kicker: '지시 콘솔',
      desc: '다듬어 둔 표현을 저장하세요. 말하는 중 트리거 단어가 나오면 해당 표현이 AI에 전달할 텍스트에 반영됩니다.',
      listTitle: '모든 짧은 구문',
      listCount: '{{count}}개',
      loading: '불러오는 중…',
      emptyTitle: '다듬어 둔 표현을 저장하고 트리거 단어로 바로 불러오세요',
      searchPlaceholder: '트리거 단어·별칭·본문 검색…',
      filterAll: '전체',
      filterPhrasing: '표현',
      filterBackground: '배경',
      emptyFiltered: '일치하는 짧은 구문이 없습니다',
      clearFilters: '검색과 필터 지우기',
      kindLabel: '종류',
      kindPhrasing: '표현',
      kindBackground: '배경',
      kindPhrasingHint: '히트하면 본문에 반영됩니다. 배경 자료를 덧붙일 수 있습니다.',
      kindBackgroundHint: '한 줄 전체가 배경 블록으로 붙습니다. 앞 또는 끝은 설정의「배경 위치」가 정합니다.',
      unsavedBadge: '저장 안 됨',
      trigger: '트리거 단어',
      triggerPlaceholder: '말하는 중에 반응합니다. 예: 번역',
      triggerHint: '필수. 같은 트리거 단어는 중복될 수 없습니다.',
      aliases: '별칭',
      aliasesPlaceholder: '별칭이 여러 개면 쉼표로 구분',
      aliasesHint: '별칭도 트리거 단어와 마찬가지로 히트합니다.',
      textPhrasing: '표현 텍스트',
      textBackground: '배경 텍스트',
      textPhrasingPlaceholder: '히트하면 AI에 전달할 텍스트에 반영됩니다',
      textBackgroundPlaceholder: '히트하면 배경 블록으로 앞 또는 끝에 붙습니다',
      attachmentsTitle: '함께 붙는 배경',
      attachmentsHint: '이 표현이 히트하면 첨부 내용도 텍스트와 함께 배경 블록에 들어갑니다.',
      attachmentAddReference: '기존 배경 선택',
      attachmentAddText: '직접 작성',
      attachmentMissingReference: '만료됨',
      attachmentNoOptions: '선택할 수 있는 배경 구문이 아직 없습니다.',
      tagPhrasingInline: '본문에 반영',
      tagBackgroundHead: '앞에 붙이기',
      tagBackgroundTail: '끝에 붙이기',
      enabled: '활성',
      editTitle: '짧은 구문 편집',
      createTitle: '새 짧은 구문',
      delete: '삭제',
      ...
      saved: '저장되었습니다',
      deleted: '삭제되었습니다',
      discardConfirm: '저장되지 않은 변경 사항이 있습니다. 버릴까요?',
      ...
      extract: '음성 기록에서 추출',
      extractTitle: '음성 기록에서 짧은 구문 추출',
      extractPickTitle: '음성 기록 선택',
      extractReviewTitle: '후보 편집',
      extractWindowNote: '전사 본문이 있는 음성 기록(전체 기록)',
      extractedMark: '추출됨',
      extractEmpty: '추출할 음성 기록이 없습니다',
      extractStart: '추출 시작',
      extractSave: '선택 항목 저장',
      extractSelectedCount: '{{count}}개 선택됨',
      extractSavedSummary: '{{count}}개 저장됨',
      extractPartialSummary: '{{count}}개 저장, {{failed}}개는 트리거 중복으로 미저장',
      extractExtracting: '추출 중…',
      extractFailed: '추출 실패: {{error}}',
      extractBack: '목록으로',
      hoursAgo: '{{n}}시간 전',
      yesterday: '어제',
      daysAgo: '{{n}}일 전',
    ...
    accuracy: {
      ...
      inputBox: "입력창 맥락",
      inputBoxDesc: "대화 세션 시작 시 커서가 있는 입력창의 기존 텍스트를 읽어 인식 맥락으로 전달해, 받아쓰기가 현재 문서에 자연스럽게 이어지도록 합니다. 대화 세션 전용, Volcengine 엔진 전용이며 텍스트는 인식 요청과 함께 Volcengine 서버로 전송됩니다. 기본값은 켜짐.",
    ...
    conversation: {
      title: '대화',
      enable: '대화 모드',
      enableDesc: '기본값은 꺼짐. 대화 단축키로 AI와의 세션을 시작하고, 질문을 받으며 말을 다듬고, 끝나면 전체 대화 기록이 지시문으로 정리됩니다. 대필 스타일(Ghostwriter 플로팅 패널)에서만 사용할 수 있습니다.',
      hotkey: '대화 단축키',
      hotkeyDesc: '세션이 없을 때 누르면＝대화 세션 시작. 명시적 전달 모드에서 세션 중에 누르면＝말을 AI에게 전달.',
      hotkeyUnsetHint: '대화 단축키가 아직 등록되지 않았습니다. 등록해야 대화를 시작할 수 있습니다.',
      hotkeyModifierOnly: '수식 키만으로는 전역 단축키를 등록할 수 없습니다. 기본 키를 추가하세요',
      timing: '응답 시점',
      timingDesc: '멈추면 바로 검토: 말이 끊기면 AI가 바로 확인. 명시적 전달: 다 말하고 단축키를 눌렀을 때만 전달(쿨다운 무시).',
      timingPause: '멈추면 바로 검토',
      timingExplicit: '명시적 전달',
      depth: '되묻기 깊이',
      depthDesc: '한 번에 하나: AI는 한 번 답하고 당신의 대답을 기다림. 끝까지 되묻기: 명확해질 때까지 질문(횟수 제한 있음). 되돌려 확인: AI가 의도를 되풀이해 확인을 구함.',
      depthSingle: '한 번에 하나',
      depthUntilClear: '끝까지 되묻기',
      depthEcho: '되돌려 확인',
      recommendations: '대화 중 추천 표시',
      recommendationsDesc: '대화 세션 패널 상단에 추천 트리거를 상시 표시하며, 내용에 따라 갱신됩니다.',
    },
  },
  nav: {
    overview: '개요',
  ...
  history: {
    ...
    ghostwriterDetail: 'Ghostwriter 상세',
    ghostwriterHits: '이번 히트',
    ghostwriterSelections: '선택한 후보',
    ghostwriterChat: '채팅 기록',
    ghostwriterChatRoleUser: '나',
    ghostwriterChatRoleAssistant: '어시스턴트',
    inserted: '입력됨',
    pasteSent: '붙여넣기 시도됨',
  ...
  vocab: {
    ...
    extract: {
      entry: '음성 기록에서 핫워드 추출',
      pickTitle: '핫워드 추출',
      pickHint: '음성 기록 선택(전사 본문이 있는 전체 기록)',
      pickEmpty: '추출할 음성 기록이 없습니다',
      selectedCount: '{{count}}개 선택됨',
      start: '추출 시작',
      extracting: '추출 중…',
      extractFailed: '추출 실패: {{error}}',
      extractEmptyResult: '인식이 흐트러진 것으로 보이는 단어가 없습니다',
      reviewTitle: '핫워드 후보 편집',
      reviewHint: '제안 핫워드는 수정할 수 있습니다. 추가할 항목을 선택하세요',
      hotwordPlaceholder: '제안 핫워드',
      saveFailedDuplicate: '사전에 같은 단어가 있거나 추가에 실패했습니다. 표기를 바꿔 다시 시도하세요',
      save: '사전에 추가',
      savedSummary: '핫워드 {{count}}개를 추가했습니다',
      partialSummary: '{{count}}개 추가, {{failed}}개는 추가되지 않았습니다',
      back: '선택으로 돌아가기',
      extractedMark: '추출됨',
      hoursAgo: '{{n}}시간 전',
      yesterday: '어제',
  ...
  settings: {
    ...
    ghostwriter: {
      ...
      backgroundPlacement: '배경 위치',
      backgroundPlacementDesc:
        '배경 구문과 덧붙인 배경은 앞 또는 끝에 통일되게 붙습니다. 변경 즉시 적용됩니다.',
      backgroundPlacementHead: '앞에 붙이기',
      backgroundPlacementTail: '끝에 붙이기',
    },
    selectionPolish: {
      title: '선택 영역 다듬기',
      hotkey: '실행 단축키',
    ...
    recording: {
      ...
      capsuleStyleFluid: 'Ghostwriter 플로팅 패널',      muteDuringRecordingLabel: '녹음 중 음소거',
