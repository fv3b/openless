...
export const zhTW: typeof zhCN = {
  ...
  ghostwriter: {
    ...
    panel: {
      ...
      recording: '語音輸入中',
      preparing: '正在準備',
      previewPlaceholder: '指令預覽將在說話後出現',
      cancelLast: '撤銷最近操作',
      noticePastedConfirm: '已傳送貼上，請確認',
      noticeCopiedFallback: '已複製，請手動貼上',
      noticeNotRequested: '處理完成',
      noticeInserted: '已輸入 {{count}} 字',
      kindTerm: '叫法',
      kindNaming: '命名',
      recommendLabel: '常用語',
      candidateLabel: '候選',
      ...
      replyPrefix: '助手',
      stageTranscribing: '正在辨識…',
      stagePolishing: '正在潤色…',
      stageFinalizing: '正在出稿…',
      stageInserting: '正在寫入…',
      failTitle: '落字失敗',
      failHint: '內容未寫入游標',
      failTimeout: '處理逾時',
    ...
    snippets: {
      title: '常用語',
      kicker: '指令台',
      desc: '存下你調優過的說法：說話中說到觸發詞，對應表述就融進貼給 AI 的文本。',
      listTitle: '全部常用語',
      listCount: '{{count}} 條',
      loading: '載入中…',
      emptyTitle: '存下你調優過的說法，用觸發詞隨叫隨到',
      searchPlaceholder: '搜尋觸發詞、別名或文字…',
      filterAll: '全部',
      filterPhrasing: '表述',
      filterBackground: '背景',
      emptyFiltered: '沒有符合的常用語',
      clearFilters: '清除搜尋與篩選',
      kindLabel: '種類',
      kindPhrasing: '表述',
      kindBackground: '背景',
      kindPhrasingHint: '命中後文本融進正文；可附帶背景材料。',
      kindBackgroundHint: '整條作為背景，附在開頭還是文末由設定裡的「背景落點」決定。',
      unsavedBadge: '未儲存',
      trigger: '觸發詞',
      triggerPlaceholder: '說話中說到就生效，例如：翻譯',
      triggerHint: '必填；同一觸發詞不可重複。',
      aliases: '別名',
      aliasesPlaceholder: '多個別名用逗號分隔',
      aliasesHint: '別名和觸發詞一樣都能命中。',
      textPhrasing: '表述文本',
      textBackground: '背景文本',
      textPhrasingPlaceholder: '命中後融進貼給 AI 的文本',
      textBackgroundPlaceholder: '命中後整條作為背景，附在開頭或文末',
      attachmentsTitle: '附帶背景',
      attachmentsHint: '命中這條表述時，附帶內容隨文本一起進背景塊。',
      attachmentAddReference: '選已有背景',
      attachmentAddText: '手寫一條',
      attachmentMissingReference: '已失效',
      attachmentNoOptions: '還沒有可選的背景類常用語。',
      tagPhrasingInline: '融進正文',
      tagBackgroundHead: '附在開頭',
      tagBackgroundTail: '附在文末',
      enabled: '啟用',
      editTitle: '編輯常用語',
      createTitle: '新建常用語',
      delete: '刪除',
      ...
      saved: '已儲存',
      deleted: '已刪除',
      discardConfirm: '改動還沒儲存，確定丟棄嗎？',
      deleteConfirm: '刪除「{{name}}」？刪除後不可恢復。',
      loadFailed: '載入失敗：{{error}}',
      saveFailed: '儲存失敗：{{error}}',
      updateFailed: '更新失敗：{{error}}',
      deleteFailed: '刪除失敗：{{error}}',
      extract: '從語音記錄提取',
      extractTitle: '從語音記錄提取常用語',
      extractPickTitle: '選擇語音記錄',
      extractReviewTitle: '編輯候選',
      extractWindowNote: '有轉寫原文的語音記錄（全部歷史）',
      extractedMark: '已提取',
      extractEmpty: '沒有可提取的語音記錄',
      extractStart: '開始提取',
      extractSave: '儲存所選',
      extractSelectedCount: '已選 {{count}} 條',
      extractSavedSummary: '已存 {{count}} 條',
      extractPartialSummary: '已存 {{count}} 條，{{failed}} 條觸發詞重複未存',
      extractExtracting: '正在提取…',
      extractFailed: '提取失敗：{{error}}',
      extractBack: '返回列表',
      hoursAgo: '{{n}} 小時前',
      yesterday: '昨天',
      daysAgo: '{{n}} 天前',
    ...
    accuracy: {
      ...
      inputBox: "輸入框偏置",
      inputBoxDesc: "對話會話啟動時讀取游標所在輸入框的已有內容，給識別當語境參考，續寫更貼合當前文稿；僅對話會話，僅火山引擎生效；內容會隨辨識請求傳到火山伺服器，預設開。",
    ...
    conversation: {
      title: '對話',
      enable: '對話模式',
      enableDesc: '預設關。按對話熱鍵開一場帶 AI 的會話，邊說邊被追問，結束後整份聊天記錄潤寫成指令；需在代筆樣式（Ghostwriter 浮框）下使用。',
      hotkey: '對話熱鍵',
      hotkeyDesc: '會話未開時按下＝開對話會話；顯式交話模式下會話開著時按下＝把話頭交給 AI。',
      hotkeyUnsetHint: '還沒錄製對話熱鍵；不錄熱鍵無法開始對話。',
      hotkeyModifierOnly: '單修飾鍵無法註冊為全域熱鍵，請加一個主鍵',
      timing: '回話時機',
      timingDesc: '停頓即審：說話一停 AI 就審你的話；顯式交話：說完按熱鍵才交話（繞過冷卻）。',
      timingPause: '停頓即審',
      timingExplicit: '顯式交話',
      depth: '追問深度',
      depthDesc: '一點一問：AI 回話後等你接話；追問到清：問到說清為止（有次數上限）；回聲確認：AI 複述意圖等你確認。',
      depthSingle: '一點一問',
      depthUntilClear: '追問到清',
      depthEcho: '回聲確認',
      recommendations: '對話中顯示推薦',
      recommendationsDesc: '對話會話浮框頂部常駐一份推薦觸發詞，隨內容重新整理不消失。',
    },
  },
  nav: {
    overview: '概覽',
  ...
  history: {
    ...
    chars: '{{count}} 字',
    vocabHits: '{{count}} 個熱詞',
    ghostwriterDetail: 'Ghostwriter 明細',
    ghostwriterHits: '本次命中',
    ghostwriterSelections: '選中的候選',
    ghostwriterChat: '聊天記錄',
    ghostwriterChatRoleUser: '我',
    ghostwriterChatRoleAssistant: '助手',
    inserted: '已插入',
    pasteSent: '已嘗試粘貼',
  ...
  vocab: {
    ...
    extract: {
      entry: '從語音記錄提取熱詞',
      pickTitle: '提取熱詞',
      pickHint: '選擇語音記錄（有轉寫原文的全部歷史）',
      pickEmpty: '沒有可提取的語音記錄',
      selectedCount: '已選 {{count}} 條',
      start: '開始提取',
      extracting: '正在提取…',
      extractFailed: '提取失敗：{{error}}',
      extractEmptyResult: '沒有提取到疑似識別混亂的詞',
      reviewTitle: '編輯候選熱詞',
      reviewHint: '建議熱詞可改；勾選後加入詞典',
      hotwordPlaceholder: '建議熱詞',
      saveFailedDuplicate: '詞典已有同詞條或新增失敗，換個寫法再試',
      save: '加入詞典',
      savedSummary: '已加入 {{count}} 個熱詞',
      partialSummary: '已加入 {{count}} 個，{{failed}} 個未加入',
      back: '返回選擇',
      extractedMark: '已提取',
      hoursAgo: '{{n}} 小時前',
      yesterday: '昨天',
  ...
  settings: {
    ...
    ghostwriter: {
      ...
      backgroundPlacement: '背景落點',
      backgroundPlacementDesc: '背景類常用語與表述的附帶背景統一附在開頭或文末；改動即時生效。',
      backgroundPlacementHead: '附在開頭',
      backgroundPlacementTail: '附在文末',
    },
    kicker: '設定',
    title: '設置',
    ...
    recording: {
      ...
      capsuleStyleFluid: 'Ghostwriter 流式浮框',      muteDuringRecordingLabel: '錄音時靜音',
