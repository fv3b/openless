...
export const zhCN = {
  ...
  ghostwriter: {
    ...
    panel: {
      ...
      recording: '语音输入中',
      preparing: '正在准备',
      previewPlaceholder: '指令预览将在说话后出现',
      cancelLast: '撤销最近操作',
      noticePastedConfirm: '已发送粘贴，请确认',
      noticeCopiedFallback: '已复制，请手动粘贴',
      noticeNotRequested: '处理完成',
      noticeInserted: '已输入 {{count}} 字',
      kindTerm: '叫法',
      kindNaming: '命名',
      recommendLabel: '常用语',
      candidateLabel: '候选',
    ...
    snippets: {
      title: '常用语',
      kicker: '指令台',
      desc: '存下你调优过的说法：说话中说到触发词，对应表述就融进贴给 AI 的文本。',
      listTitle: '全部常用语',
      listCount: '{{count}} 条',
      loading: '加载中…',
      emptyTitle: '存下你调优过的说法，用触发词随叫随到',
      searchPlaceholder: '搜索触发词、别名或文本…',
      filterAll: '全部',
      filterPhrasing: '表述',
      filterBackground: '背景',
      emptyFiltered: '没有匹配的常用语',
      clearFilters: '清除搜索与筛选',
      kindLabel: '种类',
      kindPhrasing: '表述',
      kindBackground: '背景',
      kindPhrasingHint: '命中后文本融进正文；可附带背景材料。',
      kindBackgroundHint: '整条作为背景，附在开头还是文末由设置里的「背景落点」决定。',
      unsavedBadge: '未保存',
      trigger: '触发词',
      triggerPlaceholder: '说话中说到就生效，例如：翻译',
      triggerHint: '必填；同一触发词不可重复。',
      aliases: '别名',
      aliasesPlaceholder: '多个别名用逗号分隔',
      aliasesHint: '别名和触发词一样都能命中。',
      textPhrasing: '表述文本',
      textBackground: '背景文本',
      textPhrasingPlaceholder: '命中后融进贴给 AI 的文本',
      textBackgroundPlaceholder: '命中后整条作为背景，附在开头或文末',
      attachmentsTitle: '附带背景',
      attachmentsHint: '命中这条表述时，附带内容随文本一起进背景块。',
      attachmentAddReference: '选已有背景',
      attachmentAddText: '手写一条',
      attachmentMissingReference: '已失效',
      attachmentNoOptions: '还没有可选的背景类常用语。',
      tagPhrasingInline: '融进正文',
      tagBackgroundHead: '附在开头',
      ...
      saved: '已保存',
      deleted: '已删除',
      discardConfirm: '改动还没保存，确定丢弃吗？',
      deleteConfirm: '删除「{{name}}」？删除后不可恢复。',
      loadFailed: '加载失败：{{error}}',
      saveFailed: '保存失败：{{error}}',
      updateFailed: '更新失败：{{error}}',
      deleteFailed: '删除失败：{{error}}',
      extract: '从语音记录提取',
      extractTitle: '从语音记录提取常用语',
      extractPickTitle: '选择语音记录',
      extractReviewTitle: '编辑候选',
      extractWindowNote: '有转写原文的语音记录（全部历史）',
      extractedMark: '已提取',
      extractEmpty: '没有可提取的语音记录',
      extractStart: '开始提取',
      extractSave: '保存所选',
      extractSelectedCount: '已选 {{count}} 条',
      extractSavedSummary: '已存 {{count}} 条',
      extractPartialSummary: '已存 {{count}} 条，{{failed}} 条触发词重复未存',
    ...
    accuracy: {
      ...
      inputBox: "输入框偏置",
      inputBoxDesc: "对话会话启动时读取光标所在输入框的已有内容，给识别当语境参考，续写更贴合当前文稿；仅对话会话，仅火山引擎生效；内容会随识别请求发到火山服务端，默认开。",
    ...
    conversation: {
      title: '对话',
      enable: '对话模式',
      enableDesc: '默认关。按对话热键开一场带 AI 的会话，边说边被追问，结束后整份聊天记录润写成指令；需在代笔样式（Ghostwriter 浮框）下使用。',
      hotkey: '对话热键',
      hotkeyDesc: '会话未开时按下＝开对话会话；显式交话模式下会话开着时按下＝把话头交给 AI。',
      hotkeyUnsetHint: '还没录制对话热键；不录热键无法开始对话。',
      hotkeyModifierOnly: '单修饰键无法注册为全局热键，请加一个主键',
      timing: '回话时机',
      timingDesc: '停顿即审：说话一停 AI 就审你的话；显式交话：说完按热键才交话（绕过冷却）。',
      timingPause: '停顿即审',
      timingExplicit: '显式交话',
      depth: '追问深度',
      depthDesc: '一点一问：AI 回话后等你接话；追问到清：问到说清为止（有次数上限）；回声确认：AI 复述意图等你确认。',
      depthSingle: '一点一问',
      depthUntilClear: '追问到清',
      depthEcho: '回声确认',
      recommendations: '对话中显示推荐',
      recommendationsDesc: '对话会话浮框顶部常驻一份推荐触发词，随内容刷新不消失。',
    },
  },
  nav: {
    overview: '概览',
  ...
  history: {
    ...
    chars: '{{count}} 字',
    vocabHits: '{{count}} 个热词',
    ghostwriterDetail: 'Ghostwriter 明细',
    ghostwriterHits: '本次命中',
    ghostwriterSelections: '选中的候选',
    ghostwriterChat: '聊天记录',
  ...
  vocab: {
    ...
    extract: {
      entry: '从语音记录提取热词',
      pickTitle: '提取热词',
      pickHint: '选择语音记录（有转写原文的全部历史）',
      pickEmpty: '没有可提取的语音记录',
      selectedCount: '已选 {{count}} 条',
      start: '开始提取',
      extracting: '正在提取…',
      extractFailed: '提取失败：{{error}}',
      extractEmptyResult: '没有提取到疑似识别混乱的词',
      reviewTitle: '编辑候选热词',
      reviewHint: '建议热词可改；勾选后加入词典',
      hotwordPlaceholder: '建议热词',
      saveFailedDuplicate: '词典已有同词条或添加失败，改个写法再试',
      save: '加入词典',
      savedSummary: '已加入 {{count}} 个热词',
      partialSummary: '已加入 {{count}} 个，{{failed}} 个未加入',
      back: '返回选择',
      extractedMark: '已提取',
      hoursAgo: '{{n}} 小时前',
      yesterday: '昨天',
  ...
  settings: {
    ...
    ghostwriter: {
      ...
      backgroundPlacement: '背景落点',
      backgroundPlacementDesc: '背景类常用语与表述的附带背景统一附在开头或文末；改动即时生效。',
      backgroundPlacementHead: '附在开头',
    ...
    recording: {
      ...
      capsuleStyleFluid: 'Ghostwriter 流式浮框',      muteDuringRecordingLabel: '录音时静音',
