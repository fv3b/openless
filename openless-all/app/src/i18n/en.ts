...
export const en: typeof zhCN & {
  ...
  ghostwriter: {
    ...
    snippets: {
      ...
      modeInline: 'Inline',
      modeFootnote: 'Footnote',
      modeHint: 'Inline merges at the original position; footnote appends as an end note block.',
      ...
      text: 'Phrase text',
      textPlaceholder: 'Merged into the instruction text at the placement below',
      modeLabel: 'Placement',
      enabled: 'Enabled',
      edit: 'Edit',
